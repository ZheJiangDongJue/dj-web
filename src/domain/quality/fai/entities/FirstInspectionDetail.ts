 ...
 *
 */
export type FirstInspectionDetailId = number
 ...
 *
 */
export type FirstInspectionDetailProps = {

  id: FirstInspectionDetailId
  /**
   *
   * 项目名称。
   *
 ...
 *
 */
export class FirstInspectionDetail extends Entity<FirstInspectionDetailId> {
 ...
 *
 */
  private readonly _props: FirstInspectionDetailProps
   ...
   *
   */
  public constructor(props: FirstInspectionDetailProps) {
    super(props.id)
    this._props = FirstInspectionDetail.normalizeProps(props)
  }
   ...
   *
   */
  public toProps(): FirstInspectionDetailProps {
    return {
      ...this._props,
   ...
   *
   */
  private static normalizeProps(props: FirstInspectionDetailProps): FirstInspectionDetailProps {
    return {
