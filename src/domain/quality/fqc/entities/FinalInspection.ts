...
import { FinalInspectionDetail } from './FinalInspectionDetail'
 ...
 */
 export type FinalInspectionProps = {
   ...
   *
   */
  details: readonly FinalInspectionDetail[]
}
 ...
 *
 */
  private readonly _props: FinalInspectionProps
   ...
   *
   */
  public static createDraft(): FinalInspection {
   ...
   *
   */
  public constructor(props: FinalInspectionProps) {
    super(props.id)
    this._props = FinalInspection.normalizeProps(props)
    FinalInspection.ensureUniqueDetailIds(this._props.details)
  }
   ...
   *
   */
  public get details(): readonly FinalInspectionDetail[] {
   ...
   *
   */
  public withId(id: FinalInspectionId): FinalInspection {
    return new FinalInspection({ ...this._props, id })
  }
   ...
   *
   */
  public toProps(): FinalInspectionProps {
    return {
      ...this._props,
   ...
   *
   */
  private static normalizeProps(props: FinalInspectionProps): FinalInspectionProps {
    return {
   ...
   *
   */
  private static ensureUniqueDetailIds(details: readonly FinalInspectionDetail[]): void {
