...
import {
  ...
  type FinalInspectionId,
  type FinalInspectionRepository,
  type FinalInspectionRepositoryActionResult,
} from '@/domain/quality/fqc/repositories/FinalInspectionRepository'
import { FinalInspectionMapper } from './mappers/finalInspectionMapper'

const TABLE_NAME = 'FinalInspectionDocument'
 ...
 *
 */
  public async findById(id: FinalInspectionId): Promise<FinalInspection | null> {
    ...
    return FinalInspectionMapper.toDomain({
      document,
      details,
   ...
   *
   */
  public async findByConditions(conditions: FinalInspectionFindConditions): Promise<FinalInspection[]> {
   ...
   *
   */
  public async save(entity: FinalInspection): Promise<FinalInspection> {
    const dto = FinalInspectionMapper.toPersistence(entity)
   ...
   *
   */
  public async delete(id: FinalInspectionId): Promise<FinalInspectionRepositoryActionResult> {
   ...
   *
   */
  private buildWhere(conditions: FinalInspectionFindConditions): Record<string, unknown> {
   ...
   *
   */
  private mapDbChangedResult(res: DbChangedPackResult): FinalInspectionRepositoryActionResult {
