      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-2">
          {candidates.map((c) => {
            ...
            const loc = typeof c.locationIndex === 'number' ? `工序序号：${c.locationIndex}` : ''
            return (
              <button
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div className="text-[13px] font-medium">{workType}</div>
                  <div className="text-[12px] opacity-60">{flowKind}</div>
                </div>
