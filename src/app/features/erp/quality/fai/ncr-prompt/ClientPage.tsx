...
export default function ClientPage({
  ...
  const returnTo = useMemo(() => {
    ...
    return buildQualityInspectionReturnTo('fai', billId)
  }, [getParam, billId])
  ...
  const goBackFai = useCallback(() => {
    ...
    hasNavigatedRef.current = true
    try {
      const href = buildQualityInspectionActionHref('fai', 'unapprove', billId)
      router.replace(href ?? '/features/erp/quality/fai')
    } catch {
      hasNavigatedRef.current = false
    }
